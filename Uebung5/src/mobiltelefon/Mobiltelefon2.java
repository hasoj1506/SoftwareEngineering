package mobiltelefon;
	...
	public class Mobiltelefon2 {
		...
		public Mobiltelefon2(String bBesitzer, String mMarke, String fFarbe)
		{
				besitzer = bBesitzer;
				marke = mMarke;
				farbe = fFarbe;
		...
		public boolean getSpielen(){
			return ladezustand > 20;
		}
		
		public boolean getTelefonieren(){
			return ladezustand > 21;
		}
