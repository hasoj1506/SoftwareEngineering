...
//		String [][] daten = new String[wk_model.getPruefungsliste().size()][3];
//		
//		for(int i = 0; i < wk_model.getPruefungsliste().size(); i++){
//			int zaehler = i;
//			zaehler++;
//			daten[i][0] = String.valueOf(zaehler);
//			daten[i][1] = wk_model.getPruefungsliste().get(i).getPruefungstitel();
//			daten[i][2] = String.valueOf(wk_model.getPruefungsliste().get(i).getPruefungsdauer());
//		}
//		
...
//		double preis = 0;
//		for(int i = 0; i < wk_model.getPruefungsliste().size(); i++){
//			preis = preis + wk_model.getPruefungsliste().get(i).getPruefungsdauer();
//		}
